...
export class LockManager {
  ...
  public async request(...args: RequestArgsCase3) {
    ...
    return new Promise(async function (resolve, reject) {
      ...
      console.log("requestLockQueue", requestLockQueue);
  ...
  private _updateHeldAndRequestLocks(request: Request) {
    ...
    console.log("===heldLockSet", heldLockSet, request);
  ...
  private _handleHeldLockAndRequest(
    ...
    console.log("_handleHeldLockAndRequest", heldLock);
    if (heldLock) {
  ...
  private _handleHeldLockBeSteal(request: Request) {
    console.trace("_handleHeldLockBeSteal", request);
    request.reject(
      new DOMException(
  ...
  private _handleNewLockRequest(
    ...
    console.log("_handleNewLockRequest", request);
